...
class Categoria(str, Enum):
    ...
    senalizacion_seguridad = "senalizacion_seguridad"
    equipos_emergencia = "equipos_emergencia"
    epp = "epp"
    epcc = "epcc"
    trabajo_caliente = "trabajo_caliente"
    izaje_cargas = "izaje_cargas"
    espacios_confinados = "espacios_confinados"
    trabajo_electrico = "trabajo_electrico"
    sustancias_quimicas = "sustancias_quimicas"
